...
public class EditorActivity extends AppCompatActivity implements android.app.LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void savePet(){
        ...
        if(mCurrentPetUri == null && TextUtils.isEmpty(name) && TextUtils.isEmpty(breed) && TextUtils.isEmpty(Integer.toString(weight))){
            return;
        }
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        int id = (int) ContentUris.parseId(mCurrentPetUri);
        if (cursor.moveToPosition(id-1)) {

            //cursor = getContentResolver().query(mCurrentPetUri, projection, null, null, null);
